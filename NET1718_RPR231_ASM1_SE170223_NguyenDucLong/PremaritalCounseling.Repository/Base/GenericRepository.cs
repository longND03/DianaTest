...
namespace PremaritalCounseling.Repository.Base
{
    public class GenericRepository<T> where T : class
    {
        protected Net1718Prn231PrjG2PremaritalCounselingContext _context;

        public GenericRepository()
        {
            _context ??= new Net1718Prn231PrjG2PremaritalCounselingContext();
        }

        public GenericRepository(Net1718Prn231PrjG2PremaritalCounselingContext context)
        {
            _context = context;
        }
